...
import objects.Ruteo;
import objects.Solucion;
...
//        algoritmos.add("ilp");
    ...
    public static List<DemandaInfo> definirOrdenDemandas (List<DemandaInfo> demandasInfo) {
        ...
        List<DemandaInfo> mayores = new ArrayList<>();
        List<DemandaInfo> aux;
        List<DemandaInfo> infoCopy = new ArrayList<>();
...
//        solucion.setCosto(getCostoMayor(solucion, demandasInfo)/costoMayor);
    ...
    public static List<DemandaInfo> llenarDemandInfo (String archivo) throws FileNotFoundException {
        ...
        List<DemandaInfo> demandasInfo = new ArrayList<>();
...
//            System.out.println(v + ". Inicio: " + TInicio + ", Fin: " + TFin + ", Dif: " + (TFin - TInicio) + ", sigue: " + ((TFin - TInicio) < (240000)));
     ...
     * @param demandasInfo
     */
    public static void cruce (Solucion reproductor1, Solucion reproductor2, Solucion hijo1, Solucion hijo2, List<List<Boolean>> topologia, 
            Integer totalRanuras, List<DemandaInfo> demandasInfo, String algoritmo) {
...
//    }
    ...
    public static void ordenarPorFitness (List<Solucion> soluciones) {
        ...
        List<Solucion> gruposBloq = new ArrayList<>();
        Solucion aux;
